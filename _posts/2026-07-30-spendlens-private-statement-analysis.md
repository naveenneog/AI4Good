...
tags: [ai4good, privacy, flutter, fintech, on-device, opensource]
image: /assets/img/2026-07-30-spendlens-private-statement-analysis/card.png
excerpt: "Day 17 of #AI4Good. SpendLens turns Indian bank-statement PDFs into reconciled totals, categories, and daily trends entirely on your device — no bank login, no cloud upload, no analytics, and no LLM anywhere near your money. Built with Flutter and a deterministic 78-bank parser."
---

{% assign img = '/assets/img/2026-07-30-spendlens-private-statement-analysis' %}

[![SpendLens — a bank statement analyzed entirely on-device: reconciled totals, spend by category, and a daily-spend chart, marked Verified]({{ img | append: '/card.png' | relative_url }})](https://naveenneog.github.io/SpendLens/)
...
The screenshot above is the browser version analysing a fully synthetic Axis sample: an `Axis Bank Ltd.` statement, marked **Verified**, `Active only in this tab`, spend broken out by category, and a daily-spend chart — all rendered without a single network request leaving the page.
...
*Part of the [#AI4Good](/AI4Good/2026/07/10/ai4good-an-app-a-day/) series — one build at a time, from a single laptop, with the "who does this help?" chosen first. [GitHub](https://github.com/naveenneog) · [LinkedIn](https://www.linkedin.com/in/naveen-gopalakrishna-99863040/). #AI4Good*
