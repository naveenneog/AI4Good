...
tags: [ai4good, cli, terminal, coding-agents, tab-groups, github-copilot]
image: /assets/img/2026-07-13-cordless-v0.8-groups/card.png
excerpt: "Running so many agent sessions they overflow the screen? cordless v0.8 gives them Chrome-style tab groups, lets you define your own launchers (and ships a built-in GitHub Copilot CLI profile), renames tabs, and keeps each session's scrollback across a reboot. Plus a real installer — and the story of a graceful-shutdown bug that only failed on Linux."
---

{% assign img = '/assets/img/2026-07-13-cordless-v0.8-groups' %}
...
[![cordless v0.8 — tab groups, custom launchers, Copilot]({{ img | append: '/card.png' | relative_url }})](https://naveenneog.github.io/cordless/)
