...
date: 2026-07-11 21:00:00 +0530
categories: ai4good showcase
tags: [ai4good, cli, terminal, nodejs, node-sea, tailscale]
image: /assets/img/2026-07-11-cordless-v0.6-cli-first/card.png
excerpt: "A course-correction reshaped cordless: the CLI is the product now. Run `cordless`, and it opens a full-screen terminal dashboard whose starting screen is a live pairing QR. It ships as one self-contained binary — its own Node runtime and node-pty inside — so there's nothing to install first."
---

{% assign img = '/assets/img/2026-07-11-cordless-v0.6-cli-first' %}
...
[![cordless v0.6 — the CLI-first dashboard]({{ img | append: '/card.png' | relative_url }})](https://naveenneog.github.io/cordless/)
