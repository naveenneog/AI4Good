...
tags: [ai4good, azure, foundry, claude, claude-desktop, entra-id, mdm]
image: /assets/img/2026-08-13-claude-desktop-microsoft-foundry/desktop-signin.png
excerpt: "Claude Desktop can run against Claude models in your own Microsoft Foundry resource, signed in with Microsoft Entra ID. It is a managed-configuration feature, not a settings toggle. Here is the step-by-step, verified against the shipping binary — plus the one Claude feature that cannot follow you to Foundry."
---

{% assign img = '/assets/img/2026-08-13-claude-desktop-microsoft-foundry' %}

After getting [Claude Code onto Foundry]({{ '/2026/08/13/claude-code-on-microsoft-foundry/' | relative_url }})
and then [governing it with an APIM gateway]({{ '/2026/08/13/claude-code-governance-apim-foundry/' | relative_url }}),
...
![Claude Desktop first run on Windows]({{ img | append: '/desktop-first-run.png' | relative_url }})

Sign-in offers Google or email — an **Anthropic account**. There is no "use my own endpoint" box,
and no Azure sign-in:

![Claude Desktop sign-in offering Continue with Google or email, i.e. an Anthropic account]({{ img | append: '/desktop-signin.png' | relative_url }})
...
If you already run the [APIM governance gateway]({{ '/2026/08/13/claude-code-governance-apim-foundry/' | relative_url }}),
...
- 📘 **Claude Code on Foundry:** [step-by-step]({{ '/2026/08/13/claude-code-on-microsoft-foundry/' | relative_url }})
- 📗 **Governing it with APIM:** [per-developer budgets and chargeback]({{ '/2026/08/13/claude-code-governance-apim-foundry/' | relative_url }})
