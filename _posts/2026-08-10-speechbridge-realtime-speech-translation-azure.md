...
tags: [ai4good, azure, speech, translation, accessibility, opensource]
image: /assets/img/2026-08-10-speechbridge-realtime-speech-translation-azure/card.png
excerpt: "Two people who don't share a language, one laptop, and about half a second of delay. SpeechBridge is an open-source Azure Solution Accelerator for live interpreted conversation — with no API keys anywhere, one-command deployment, and a README that names the situations where you must not use it."
---

{% assign img = '/assets/img/2026-08-10-speechbridge-realtime-speech-translation-azure' %}

[![SpeechBridge translating English to Hindi in real time — the speaker's panel shows "Good morning." while the listener's panel shows "सुप्रभात।", with per-turn latency displayed as 0.2s, 0.2s, 0.4s]({{ img | append: '/card.png' | relative_url }})](https://github.com/naveenneog/speechbridge)
...
[![The reverse direction — Hindi to English, "नमस्ते।" becoming "Hello." with its own measured latency]({{ img | append: '/reverse.png' | relative_url }})](https://github.com/naveenneog/speechbridge)
